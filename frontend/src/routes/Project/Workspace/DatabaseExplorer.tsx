...
import { ChevronRight, ChevronDown, Database, Table2, Layers } from 'lucide-react';
...
export function DatabaseExplorer({ nodes }: DatabaseExplorerProps) {
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto py-1 space-y-0.5">
        ...
        <ExplorerSection
          ...
          items={sources}
          getLabel={(n) => `${n.source_name}.${n.name}`}
          getDragText={(n) => `{{ source('${n.source_name}', '${n.name}') }}`}
        />
